<footer class="footer">
    <div class="container py-5">
        <div class="row g-4">
            <div class="col-lg-4"><a class="footer-brand" href="<?= e(url()) ?>">L2 <strong>Chemicals</strong></a><p class="mt-3"><?= e($settings['footer_description'] ?? 'Reliable supply partner for thermoplastic resins and polymer additives.') ?></p></div>
